...
namespace SSS.TestWeb
{
    public class AppOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        /// </summary>  
        private dbAccess databaseManager = new dbAccess();
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            var user = this.databaseManager.Login(usernameVal, passwordVal).ToList();
            ...
            claims.Add(new Claim(ClaimTypes.PrimarySid, userInfo.Id.ToString()));
            ...
            AuthenticationProperties properties = CreateProperties(userInfo.Name);
